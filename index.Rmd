---
title: "Mapa de conectividad de grupos funcionales de aves migratorias en el Corredor Biológico Interurbano María Aguilar"
output: 
...
url_raster_probabilidad_conectividad <-
  "https://raw.githubusercontent.com/atlas-servicios-ecosistemicos-gam/datos/master/conectividad/cbima/migratorias/PROBABILIDAD_CONECTIVIDAD_MIGRATORIAS_MA_WEB.TIF"

url_agfs_teselas <-
  "https://services9.arcgis.com/RrvMEynxDB8hycVO/arcgis/rest/services/gam_conectividad_parches_esenciales_importantes_migratorias_ma/FeatureServer/0"

url_agfs_rutas <-
  "https://services9.arcgis.com/RrvMEynxDB8hycVO/arcgis/rest/services/gam_conectividad_rutas_conectividad_migratorias_ma/FeatureServer/0"
...
# Esencialidad
bins_esencialidad <- c(0, 0.0005526, 0.0015975, 0.0034473, 0.0395314, Inf)
...
# Importancia
bins_importancia <- c(0, 80791242245.90, 429380338472.00, 1887921146650.00, 9492422363870.00, Inf)
